...
Install [Loqolizer](#) to enable mods localize. The mod has a snapshot of translate texts in release time, only for the latest version of each mods.

~~If you're offline and want old mod translate packages, you can also download [addictional translate](https://frto027.github.io/ssl10n.csv/index.html) package for your mods.~~
